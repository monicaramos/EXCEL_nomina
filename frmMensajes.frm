...
Dim ItmX
    ...
    If Not Rs.EOF Then
        ...
        ListView7.ColumnHeaders.Add , , "Nº Asesoria", 1000
        ListView7.ColumnHeaders.Add , , "Error", 3000, 0
    
        While Not Rs.EOF
            Set ItmX = ListView7.ListItems.Add
            ItmX.Text = Format(Rs!codigo1, "000000")
            
            
            Select Case Rs!campo1
                Case 1
                    ItmX.SubItems(1) = "No existe Codigo Asesoria."
                Case 2
                    ItmX.SubItems(1) = "Codigo duplicado."
                Case 3
                    ItmX.SubItems(1) = "Ya existe registro para ese codigo asesoria y fecha."
            End Select
